export PJDIR := /Users/imjunhyeong/Practice/Android/VoipTest/app/src/main/cpp/pjsip_sources
...
export STD_CPP_LIB := /Users/imjunhyeong/Library/Android/sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so
...
export APP_CC := /Users/imjunhyeong/Library/Android/sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang
export APP_CXX := /Users/imjunhyeong/Library/Android/sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang++
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
        ...
        $(PJ_VIDEO_LDFLAGS) \
         /Users/imjunhyeong/Library/Android/sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/lib64/clang/14.0.6/lib/linux/aarch64/libunwind.a -latomic -target aarch64-none-linux-android33 -no-canonical-prefixes -Wl,--build-id=sha1 -nostdlib++ -Wl,--no-undefined -Wl,--fatal-warnings -lc -lm  
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
        ...
        $(APP_THIRD_PARTY_EXT)\
        $(PJLIB_LDLIB) \
        -lmediandk -lm  /Users/imjunhyeong/Library/Android/sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so -lOpenSLES -llog -lGLESv2 -lEGL -landroid
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lmediandk -lm  /Users/imjunhyeong/Library/Android/sdk/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/lib/aarch64-linux-android/libc++_shared.so -lOpenSLES -llog -lGLESv2 -lEGL -landroid
